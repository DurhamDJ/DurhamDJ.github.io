            ...
            <div class="col-md-9 dj-content">\
                <div class="row content-row">\
                    ...
                    <div class="col-2 dropdown-container">\
                        <img src="assets/img/dropdown.svg" class="music-expand" onclick="toggleMusic(this)">\
                    </div>\
                </div>\
            </div>\
        </div>\
...
function generateMixcloudFrame(id) {
    const iframeProps = defaultIframeProps + 'height="120"';
...
function generateYouTubeFrame(id) {
    const iframeProps = defaultIframeProps + 'height="400" allow="accelerometer;autoplay;encrypted-media;gyroscope;picture-in-picture" allowfullscreen';
    return `<iframe ${iframeProps} source="https://www.youtube-nocookie.com/embed/${id}">Loading...</iframe>`;
}
function generateHearthIsFrame(id) {
    const iframeProps = defaultIframeProps + `height="150" allowtransparency allow="autoplay" id="hearthis_at_track_${id}"`;
